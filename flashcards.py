...
class Flashcard:
    ...
    def __init__(self):
        ...
        self.__total_random_questions = 10
    ...
    def __display_subject_title(self):
        """Print the chosen subject title."""
        print(f"\n--- {self.__subjects[self.__chosen_subject]} ---")
    ...
    def __build_random_qa_session(self):
        ...
        while len(self.__random_questions) < self.__total_random_questions:
            self.__choose_random_subject()
            self.__build_subject_qa_session()
            self.__choose_random_question_number()
            self.__build_random_questions_and_answers()
    ...
    def __build_random_questions_and_answers(self):
        """Add a new question and its answer to the random questions and answers lists."""
